...
eMUNetworkUT::udp::socketMock_t::socketMock_t(ioServiceStub_t &ioService,
...
void eMUNetworkUT::udp::socketMock_t::impl_async_receive_from(boost::asio::mutable_buffers_1 &buffer,
...
void eMUNetworkUT::udp::socketMock_t::expectCall_async_receive_from() {
    EXPECT_CALL(*this, async_receive_from(::testing::_, ::testing::_, ::testing::_));
}

void eMUNetworkUT::udp::socketMock_t::impl_async_send_to(boost::asio::mutable_buffers_1 &buffer,
...
void eMUNetworkUT::udp::socketMock_t::expectCall_async_send_to() {
