...
public:
    MOCK_METHOD1(onReceive, void(eMUNetwork::socket_t<ioServiceMock_t, socketStub_t>::ptr_t ptr));
    MOCK_METHOD1(onClose, void(eMUNetwork::socket_t<ioServiceMock_t, socketStub_t>::ptr_t ptr));
};
