...
TEST(readBufferTest, clear) {
    eMUNetwork::readBuffer_t rbuf;
    rbuf.payload_[0] = 0x01;
    rbuf.payload_[eMUNetwork::maxPayloadSize_c - 1] = 0x02;
    rbuf.payloadSize_ = eMUNetwork::maxPayloadSize_c;
...
protected:
    ...
    void initializePatternBuf() {
        ...
        BOOST_FOREACH(uint8 &e, patternBuf_.payload_)
        {
            e = value++;
        }
...
TEST_F(writeBufferTest_t, insert) {
